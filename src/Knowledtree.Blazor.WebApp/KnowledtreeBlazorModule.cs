...
using Knowledtree.Blazor.WebApp.Client;
using Knowledtree.Blazor.WebApp.Client.Menus;
using Knowledtree.Blazor.WebApp.Components;
...
public class KnowledtreeBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Knowledtree.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new KnowledtreeMenuContributor(context.Services.GetConfiguration()));
        });
    }
