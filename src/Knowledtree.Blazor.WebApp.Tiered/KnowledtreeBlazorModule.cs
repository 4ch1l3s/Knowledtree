...
using Knowledtree.Blazor.WebApp.Tiered.Client;
using Knowledtree.Blazor.WebApp.Tiered.Client.Menus;
using Knowledtree.Blazor.WebApp.Tiered.Components;
using Knowledtree.Blazor.WebApp.Tiered.Menus;
...
[DependsOn(
    typeof(KnowledtreeHttpApiClientModule),
...
public class KnowledtreeBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(KnowledtreeBlazorModule).Assembly
            );
        });
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Knowledtree.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<KnowledtreeBlazorModule>(hostingEnvironment.ContentRootPath);
            });
        }
    }
    ...
    private void ConfigureMenu(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new KnowledtreeMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new KnowledtreeToolbarContributor());
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(KnowledtreeBlazorModule).Assembly;
            options.AdditionalAssemblies.Add(typeof(KnowledtreeBlazorClientModule).Assembly);
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<KnowledtreeBlazorModule>();
        });
    }
    ...
    {
        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("Knowledtree");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]!);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "Knowledtree-Protection-Keys");
        }
    }
