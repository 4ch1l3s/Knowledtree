...
namespace Knowledtree.Migrations
{
    ...
    [Migration("20260809030917_Added_DailyMissions")]
    partial class Added_DailyMissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Knowledtree.DailyMissions.DailyMission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("IsActive", "RewardType");

                    b.ToTable("AppDailyMissions", null, t =>
                        {
            ...
            modelBuilder.Entity("Knowledtree.DailyMissions.UserDailyMission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "MissionDate", "Slot")
                        .IsUnique();

                    b.ToTable("AppUserDailyMissions", null, t =>
                        {
            ...
            modelBuilder.Entity("Knowledtree.Friendships.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Knowledtree.Tags.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Knowledtree.Trees.PlantingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DuplicateCoinReward")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("DuplicateGemReward")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int?>("ResultTreeId")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("ServerEndTime")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime>("ServerStartTime")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Knowledtree.Trees.Tree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppTrees", (string)null);
                });

            modelBuilder.Entity("Knowledtree.Trees.TreePool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppTreePools", (string)null);
                });

            modelBuilder.Entity("Knowledtree.Trees.TreePoolItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Knowledtree.Trees.UserTree", b =>
                {
                    ...
                    b.Property<DateTime>("FirstObtainedAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int?>("FirstObtainedFromPoolId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalObtainedCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
                    ...
                    b.HasIndex("FirstObtainedFromPoolId");

                    b.HasIndex("TreeId");

                    b.HasIndex("UserId", "TreeId")
                        .IsUnique();

                    b.ToTable("AppUserTrees", (string)null);
                });

            modelBuilder.Entity("Knowledtree.UserAvatars.UserAvatar", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Knowledtree.DailyMissions.UserDailyMission", b =>
                {
                    b.HasOne("Knowledtree.DailyMissions.DailyMission", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Knowledtree.Trees.PlantingSession", b =>
                {
                    b.HasOne("Knowledtree.Trees.Tree", null)
                        .WithMany()
                        .HasForeignKey("ResultTreeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Knowledtree.Tags.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Knowledtree.Trees.UserTree", b =>
                {
                    b.HasOne("Knowledtree.Trees.TreePool", null)
                        .WithMany()
                        .HasForeignKey("FirstObtainedFromPoolId")
                        .OnDelete(DeleteBehavior.Restrict);
